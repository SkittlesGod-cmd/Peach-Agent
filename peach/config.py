...
def load_config(home: str | None = None) -> PeachConfig:
    ...
    return PeachConfig(
        ...
        alpaca_api_key=os.getenv("ALPACA_API_KEY", data.get("alpaca_api_key")),
        alpaca_secret_key=os.getenv("ALPACA_SECRET_KEY", data.get("alpaca_secret_key")),
        alpaca_paper=_as_bool(os.getenv("ALPACA_PAPER", data.get("alpaca_paper")), True),
